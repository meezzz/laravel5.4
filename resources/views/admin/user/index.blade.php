        ...
        <div class="mws-panel-body no-padding">
            <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
                    ...
                    <div id="DataTables_Table_1_length" class="dataTables_length">
                        <label>
                            ...
                            <select size="1" name="num" aria-controls="DataTables_Table_1">
                                ...
                                <option value="2" @if($request->input('num') == 2)  selected  @endif>
                                    2
                                </option>
                            </select>
                            条
                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1"
                    ...
                    @foreach($users as $k=>$v)
                        <tr class="@if($k % 2 == 0)  even @else odd @endif ">
                            ...
                            <td class=" ">
                                <img src="{{$v->profile}}" width="35" alt="">
                            </td>

                            <td class=" ">
                                <a href="/admin/user/edit/{{$v->id}}" class="btn"><i class="icon-pencil"></i></a>
                                <a href="/admin/user/delete/{{$v->id}}" class="btn btn-warning" onclick="javascript:return del();"><i class="icon-remove-sign"></i></a>
                            </td>
                ...
                <div class="dataTables_paginate paging_full_numbers" id="DataTables_Table_1_paginate">
                    ...
                    <div id="pages">
{{--                        {{ $users->appends(['keyword' => $request->input('keyword'),'num' => $request->input('keyword')])->links() }}--}}
